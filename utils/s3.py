...
class s3_handler():
    ...
    def get_object(self, bucket_name, obj_name):
        ...
        return self.resource.Object(bucket_name, obj_name).get()
    
    def get_object_client(self, bucket_name, obj_name):
        
        return self.client.get_object(Bucket=bucket_name, Key=obj_name)['Body'].read() # retrun byte
